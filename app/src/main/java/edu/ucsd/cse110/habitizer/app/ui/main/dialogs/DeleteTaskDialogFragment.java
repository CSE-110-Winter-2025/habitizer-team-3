...
public class DeleteTaskDialogFragment extends DialogFragment {
    ...
    public static DeleteTaskDialogFragment newInstance(DeleteTaskDialogParams params) {
    ...
    private void onPositiveButtonClick(DialogInterface dialog, int which) {
        DeleteTaskRequest req = new DeleteTaskRequest(routineId, taskId, taskSortOrder);
        activityModel.deleteTask(req);
        dialog.dismiss();
    }
    ...
    public void onDismiss(@Nullable DialogInterface dialog) {
        ...
        getParentFragmentManager().setFragmentResult("DELETE_TASK_DIALOG_DISMISSED", result);
    }
}